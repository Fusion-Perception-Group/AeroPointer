...
namespace safe_landing_planner
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(WaypointGeneratorNodeConfig &config, const WaypointGeneratorNodeConfig &max, const WaypointGeneratorNodeConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const WaypointGeneratorNodeConfig &config1, const WaypointGeneratorNodeConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, WaypointGeneratorNodeConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const WaypointGeneratorNodeConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, WaypointGeneratorNodeConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const WaypointGeneratorNodeConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const WaypointGeneratorNodeConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, WaypointGeneratorNodeConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
